...
namespace MK.Toon
{
    ...
    {        
        ...
        private MaterialProperty showWavyBehavior = null;

        //Main
        private MaterialProperty mainColor = null;
        private MaterialProperty mainTex = null;
        private MaterialProperty transp = null;
        ...
        private MaterialProperty wavySpeed = null;
        ...
        public void FindProperties(MaterialProperty[] props, Material mat)
        {
            ...
            showWavyBehavior = FindProperty("_MKEditorShowWavyBehavior", props);

            //Main
            mainColor = FindProperty("_Color", props);
            mainTex = FindProperty("_MainTex", props);
            transp = FindProperty("_Transp", props);
            ...
            wavySpeed = FindProperty("_WavySpeed", props);
        }
        ...
        override public void OnGUI(MaterialEditor materialEditor, MaterialProperty[] properties)
        {
            ...
            if (HandleBehavior("Main", ref showMainBehavior, materialEditor))
            {
                ...
                materialEditor.ShaderProperty(transp, transp.displayName);
            ...
            if (HandleBehavior("Wavy", ref showWavyBehavior, materialEditor))
            {
                materialEditor.ShaderProperty(wavySpeed, wavySpeed.displayName);
            }
            ///Other
