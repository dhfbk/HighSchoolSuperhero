Shader "MK/Toon/FreeTranspWater"
{
	Properties
	{
		//Main
		...
		//Wavy speed
		_WavySpeed ("Wavy speed", Range(0.0,3.0)) = 0
		...
		[HideInInspector] _MKEditorShowWavyBehavior ("Wavy Behavior", int) = 0
	}
	SubShader
	{
		LOD 300
        ...
        {
            Name "META"
            Tags {"Queue"="Transparent" "RenderType"="Transparent""LightMode"="Meta" }
			//
			Blend SrcAlpha OneMinusSrcAlpha
            Cull Off
